...
import { Home, Search, ShieldCheck, User, LogOut } from "lucide-react";
        ...
        <div id="user-header-actions" className="flex items-center gap-2 shrink-0">
          {currentUser ? (
            <div className="flex items-center gap-2 bg-gray-50 border border-gray-100 rounded-2xl p-1.5 pr-3 select-none">
              ...
              <button
                onClick={logout}
                className="ml-1 text-gray-400 hover:text-red-500 p-1 rounded-lg hover:bg-gray-200/60 transition-colors cursor-pointer bg-transparent border-none"
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="hidden xs:inline-flex items-center justify-center px-3.5 py-2 hover:bg-gray-50 text-gray-700 rounded-xl font-bold text-xs transition-colors cursor-pointer bg-transparent border-none"
              >
                Đăng Nhập
              </button>
              <button
                onClick={onRegisterClick}
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs py-2 px-3.5 rounded-xl transition-all shadow-md shadow-blue-500/10 hover:shadow-blue-500/20 cursor-pointer flex items-center gap-1 border-none"
              >
